      ...
      <div className="mx-auto max-w-6xl px-6 pb-24 pt-20 md:pb-32 md:pt-28">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <div className="flex flex-col items-center justify-center gap-4 sm:flex-row">
            <Button size="lg" className="w-full bg-emerald-600 text-base hover:bg-emerald-700 sm:w-auto" asChild>
              <Link to="/signup">
        ...
        <div className="mx-auto grid max-w-4xl gap-6 md:grid-cols-3">
          ...
          <Card className="relative border-2 border-emerald-600 bg-background shadow-lg">
            ...
            <CardContent>
              ...
              <Button className="mt-6 w-full bg-emerald-600 hover:bg-emerald-700" asChild>
                <Link to="/signup">Essai gratuit 14 jours</Link>
              </Button>
            </CardContent>
          </Card>
    ...
    <section className="border-t py-24">
      <div className="mx-auto max-w-6xl px-6">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <Button size="lg" className="bg-emerald-600 text-base hover:bg-emerald-700" asChild>
            <Link to="/signup">
